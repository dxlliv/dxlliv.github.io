export const messages = {
    en: {
        intro: {
            ...
            title2: "Independent <br />",
        },
        availability: {
            available: "Available"
        },
        specialization: "DEV",
        skills: "Pixel Perfect Design ▪ UI/UX Battle Tester & Enhancer ▪ Web Developer ▪ Web Designer ▪ Web Strategist ▪ Silent Consultant ▪ HTML5 ▪ JavaScript ▪ TypeScript ▪ Vue.js ▪ Nuxt.js ▪ Routing ▪ State Management ▪ Single-page Application ▪ Vuex ▪ Pinia ▪ Xstate ▪ Capacitor ▪ Electron ▪ Server-side Rendering ▪ Static Site Generation ▪",
        form: {
            fields: {
                name: {
                    label: "Name",
        ...
        pages: {
            home: {
                me: {
                    ...
                    description: {
                        p1: "Hire an expert consultant for your<br class='hidden-sm-and-up' /> next <span class='hidden-sm-and-up'>awesome</span> project.<br class='hidden-xs' /> I specialize in <span class='hidden-xs'>web</span><br class='hidden-sm-and-up' /> <span class='hidden-sm-and-up'>web </span>design and web development.",
                ...
                dev: {
                    ...
                    description: {
                        p1: "As an independent <span class='hidden-sm-and-up'>web </span>developer<br class='hidden-sm-and-up' /> and designer,<br class='hidden-xs' /> <span class='hidden-sm-and-up'>I can provide modern <br class='hidden-sm-and-up' />solutions and support of all kinds</span><span class='hidden-xs'>I build modern<br class='hidden-sm-and-up' /> websites and web applications</span>.",
